...
/**
 * Um orcamento so tem dois estados, e nenhum dos dois e escolhido a mao:
 *   no aparelho — existe so no celular, ainda nao subiu (ver lib/rascunhos);
 *   no banco    — subiu, e a partir dai vale para todo mundo.
 *
 * A coluna `status` do banco aceita outros valores por historico, mas o app
 * so grava 'enviado'. Se um dia houver acompanhamento de aprovado/recusado,
 * o lugar ja esta reservado.
 */
